    ...
    return (
        <div className="my-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 w-3/4 mx-auto gap-8">
                {/* Tried to use AOS in this section */}
                <div data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="3000"><img src="https://i.ibb.co/7ptt0QN/kid-playing-home.jpg" alt="" className="rounded-lg" /></div>
                <div data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="3000">
